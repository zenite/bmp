...
_shared.service('workflowModuleTransfer', [
    ...
    function (asdialog, dialog, service, bpmService, session, $rootScope) {
        ...
        function newWindow(pageInfo) {
            mabp.openWin("/SysPages/AppPage?nodeId={0}&pageId={1}&jobId={2}&taskId={3}&procId={4}&draftId={5}&areaCode={6}&topic={7}&isWaiting={8}".fill(
                pageInfo.nodeId,
                pageInfo.pageId,
                pageInfo.jobId,
                pageInfo.taskId,
        ...
        function getPageAndJump(pageInfo, pageId, nodeId, instData) {
            ...
            if (!!instData) {
                ...
                pageInfo.isWaiting = instData.isWaiting;
                pageInfo.reloadTasks = instData.reloadTasks;
            }
