...
(function () {
    ...
    String.prototype.insert = function (str, index, length) {
        if (!length) length = 0;
        var newstr = this.substring(0, index - length);
        newstr = newstr + str + this.substring(index);
        return newstr;
    };
...
(function ($, window) {
    ...
    ModalTrigger.prototype.show = function (option) {
        ...
        $dialog.toggleClass('modal-sm', options.size === 'sm')//最小号
            .toggleClass('modal-ms', options.size === 'ms')//中偏小
            .toggleClass('modal-md', options.size === 'md')//中
            .toggleClass('modal-lm', options.size === 'lm')//大偏小
            .toggleClass('modal-lg', options.size === 'lg')//大
            .toggleClass('modal-fullscreen', options.size === 'fullscreen'); //全屏
...
+ function ($) {
    ...
    Popover.prototype.setContent = function () {
        ...
        if (content instanceof jQuery) {
            $tip.find('.popover-content').html() || $tip.find('.popover-content').append(content);
