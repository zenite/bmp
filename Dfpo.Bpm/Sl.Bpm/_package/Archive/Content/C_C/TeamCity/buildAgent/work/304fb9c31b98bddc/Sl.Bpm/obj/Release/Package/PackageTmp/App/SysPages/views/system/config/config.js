(function () {
    ...
    angular.module('syspages').controller(controllerId, [
        '$scope', '$modal', 'dialog', 'asdialog', 'mabp.app.bpm', 'mabp.app.enterpriseInfoSync', 'mabp.app.workflow',
        function ($scope, $modal, dialog, asdialog, service, syncService, wfService) {
            var vm = this;
