...
'zrender/shape/Polyline'], function (zrender, cirle, rectangle, polyline) {
    ...
    */
    var createChart = function (domId, jsonData, dropCallBack, dragStart, dbClick, rightDelete, rightNext) {
        var RECT_WIDTH = 90;
        ...
        function extendBoxWidthAndHeight() {
            ...
            var maxWidthCol = _.maxBy(posCol, function (i) { return i.nodes.length; });
            var maxWidth = maxWidthCol.nodes[maxWidthCol.nodes.length - 1].style.x + RECT_WIDTH + WIDTH_GAP;
