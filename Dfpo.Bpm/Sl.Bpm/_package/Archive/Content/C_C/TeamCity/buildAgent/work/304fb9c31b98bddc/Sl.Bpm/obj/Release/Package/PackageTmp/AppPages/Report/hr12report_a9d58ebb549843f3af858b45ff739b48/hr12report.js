...
function controller(base, form, program) {
    ...
    form.$watch('form.currentData', function (newV) {
        if (!!newV) {
            ...
            allSnNumber.on('click', function () {
                var id = $(this).attr('id');
                var row = _.find(form.HR12Report, { id: id });
                debugger;
    ...
    form.clear = function () {
        form.filter = {
            ...
            rcommendJob: null,
            isCandidateInYfVisteon: null,
            isWasCandidateInVendorCompany: null,
            wasCandidateInVendorCompany: null,
            isCandidateInVendorCompany:null
        }
    }
}