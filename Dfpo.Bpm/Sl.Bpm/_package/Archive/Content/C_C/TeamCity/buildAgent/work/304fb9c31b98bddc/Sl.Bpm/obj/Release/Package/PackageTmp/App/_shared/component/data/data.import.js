        ...
        function (params, $scope, fileUploader, service) {
            ...
            vm.uploader.filters.push({
                ...
                fn: function (item, options) {
                    if ((item.type === "application/vnd.ms-excel" && item.name.indexOf('.xls') > 0) ||
                    (item.type === "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" && item.name.indexOf('.xlsx') > 0)) {
                        return true;
                    } else {
