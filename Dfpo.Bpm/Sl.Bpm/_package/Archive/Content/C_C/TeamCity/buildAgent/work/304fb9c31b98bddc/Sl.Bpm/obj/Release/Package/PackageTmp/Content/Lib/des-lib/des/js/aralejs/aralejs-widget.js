define("aralejs-widget", function(require, exports, module) {
	...
	var Base = require('aralejs-base')
	var $ = require('jquery')
	var DAParser = require('aralejs-widget-daparser')
	var AutoRender = require('aralejs-widget-auto-render')
