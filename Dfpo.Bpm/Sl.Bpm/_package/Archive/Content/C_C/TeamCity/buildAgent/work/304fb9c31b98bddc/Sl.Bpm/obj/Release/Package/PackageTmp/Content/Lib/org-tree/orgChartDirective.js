        ...
        'treeTool', function(treeTool) {
            return {
                ...
                link: function(scope, element, attr) {
                    ...
                    scope.$watch("jobUsers", function (newValue, oldValue, scope) {
                        var jobUsers = scope.jobUsers;
                        if (jobUsers == null || jobUsers.length === 0) {
                            return;
                        }
                        //更新用户树
                        var allJobs = _.groupBy(jobUsers, 'jobId');
