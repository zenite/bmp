...
.directive("fmDataSelect", ['fmTool', '$timeout', 'dialog', 'mabp.app.module', 'mabp.app.bpm', function (fmTool, $timeout, dialog, service, bpmService) {
    return {
        ...
        template: function (elem, attr) {
            ...
            return '<div fm-model="' + attr.fmModel + '" class="input-sm ma-data-select ' + (attr.ismulti ? 'multi' : 'single') + ' ' + attr.class + '" ng-class="state" ng-mousedown="openSelect($event)" ng-blur="event_Blur()">' +
