(function () {
    var controllerId = _shared.dialogs.define('actoruserSelectInform', '/App/_shared/inform/actoruser.select.inform.html');
    angular.module('app.shared').controller(controllerId, [
        ...
        function (params, $scope, dialog, $stateParams, service) {
            ...
            vm.actorList = {
                //下一步处理人
                NextProcessor: { text: L("NextProcessor"), value: 20 },
