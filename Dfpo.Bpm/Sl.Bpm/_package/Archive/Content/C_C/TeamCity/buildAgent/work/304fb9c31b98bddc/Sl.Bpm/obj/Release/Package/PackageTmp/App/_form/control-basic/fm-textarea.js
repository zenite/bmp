_shared.directive('fmTextarea', ['fmTool', '$timeout', function (fmTool, $timeout) {
    return {
        ...
        template: function (elem, attr) {
            ...
            return '<div fm-model="' + attr.fmModel + '" field-text="{{fmModel}}" class="input-sm fm-text form-control multiline" ng-class="state" ng-mousedown="event_textboxClick($event)" ng-keydown="event_textBoxKeyDown($event)">' +
                        ...
                        '<label class="fm-text-shadetext">{{fmModel}}</label>' + //readonly时作为主要显示文本，其他状态下为遮罩层
