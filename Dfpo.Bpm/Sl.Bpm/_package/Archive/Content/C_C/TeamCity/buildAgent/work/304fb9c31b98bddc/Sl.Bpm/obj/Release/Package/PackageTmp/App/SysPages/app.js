...
app && (function () {
    ...
    app.controller('layoutController', [
            '$rootScope', 'w5cValidator', 'appSession', '$scope', function ($rootScope, w5cValidator, appSession, $scope) {
                var vm = this;
        ...
        function ($rootScope, service, appSession, $translate, $location, bpmService) {
            ...
            $rootScope.$on('$stateChangeSuccess', function (event, toState, toParams, fromState, fromParams) {
                ...
                if (toState.parentMenu != null) {
                    ...
                    //                        if (!!toState.adminRequired && !$rootScope.isSuperAdmin) {
                    //                            $location.path('/');
                    //                        }
                } else {
                    $rootScope.activeEnterprise = null;
