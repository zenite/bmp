(function () {
    ...
    angular.module('syspages').controller(controllerId, [
        ...
        function ($scope, $modal, dialog, asdialog, service, module) {
            ...
            function getMyWaitedTasksDataTable() {
            ...
            vm.load = function (isRefresh) {
                vm.paging.filters = [{ name: 'moduleIds', value: vm.moduleIds }, { name: 'filterText', value: vm.filterText }, { name: 'moduleType', value: '10' }];
                vm.paging.filters = vm.paging.filters.concat(mabp.toArray(vm.filter));

                if (isRefresh)
                    mabp.ui.setLoading(".panel-body", getMyWaitedTasksDataTable());
                else
                    getMyWaitedTasksDataTable();
            }
